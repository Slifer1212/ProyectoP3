...
public class CreateBookFormatValidator : AbstractValidator<CreateBookDto>
{
    public CreateBookFormatValidator()
    {
        RuleFor(x => x.Title)
        ...
        RuleFor(x => x.GenreIds)
            ...
            .Must(ids => ids != null && ids.Count > 0).WithMessage("Genre IDs list cannot be empty.");
